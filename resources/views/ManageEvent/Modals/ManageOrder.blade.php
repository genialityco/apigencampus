            ...
            <div class="modal-body">
                ...
                <div class="p0 well bgcolor-white order_overview">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <b>Evento</b><br> {{$order->event->name}}
                        </div>
                        ...
                        <div class="col-sm-6 col-xs-6">
                          {{--NOTMOCION  <b>@lang("Order.payment_gateway")</b><br> <a href="{{ $order->payment_gateway->provider_url }}" target="_blank">{{$order->payment_gateway->provider_name}}</a>
                          --}}  </div>
                        @endif
