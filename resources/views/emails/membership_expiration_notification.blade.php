...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    <p style="text-align: center; margin: 20px 0;">
        <a href="https://app.geniality.com.co/myprofile/organization" style="background-color: #1E90FF; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">
